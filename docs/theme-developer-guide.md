# hyprricer: The Theme Developer's Guide

Welcome to **hyprricer**. Unlike traditional "dotfile managers" that just copy files, `hyprricer` allows you to build **Reactive Themes** that change instantly based on system events (Music, Battery, Time, Weather, etc.).
...
A `hyprricer` theme consists of three parts:
...
hyprricer build --profile my_dev_profile
